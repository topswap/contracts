...
describe('BSCswapPair', () => {
  ...
  optimisticTestCases.forEach((optimisticTestCase, i) => {
    it(`optimistic:${i}`, async () => {
      ...
      await expect(pair.swap(outputAmount.add(1), 0, wallet.address, '0x', overrides)).to.be.revertedWith('BSCswap: K')
  ...
  it('swap:gas', async () => {
    ...
    expect(receipt.gasUsed).to.eq(73895)
  })
